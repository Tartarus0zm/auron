error id: file://<WORKSPACE>/spark-extension/src/main/scala/org/apache/spark/sql/blaze/NativeHelper.scala:scala/Predef.String#
file://<WORKSPACE>/spark-extension/src/main/scala/org/apache/spark/sql/blaze/NativeHelper.scala
...
non-local guesses:
	 ...
	 -scala/Predef.String#
offset: 3443
uri: file://<WORKSPACE>/spark-extension/src/main/scala/org/apache/spark/sql/blaze/NativeHelper.scala
text:
```scala
/*
...
object NativeHelper extends Logging {
  ...
  def getDefaultNativeMetrics(sc: SparkContext): Map[String, SQLMetric] = {
    ...
    def nanoTimingMetric(name: Strin@@g) = SQLMetrics.createNanoTimingMetric(sc, name)
