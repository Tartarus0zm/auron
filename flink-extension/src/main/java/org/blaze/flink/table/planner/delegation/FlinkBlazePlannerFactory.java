 ...
 */
package org.blaze.flink.table.planner.delegation;
...
/** Factory for the flink blaze {@link Planner}. */
@Internal
public final class FlinkBlazePlannerFactory implements PlannerFactory {

    public static final String IDENTIFIER = "FlinkBlazePlanner";
    ...
    public Planner create(Context context) {
        ...
        switch (runtimeExecutionMode) {
            case STREAMING:
                return new FlinkBlazeStreamPlanner(
                        context.getExecutor(),
            ...
            case BATCH:
                throw new TableException(String.format(
                        "Unsupported mode '%s' for '%s'. Only an explicit "
